...
THREE.GPUParticleSystem = function( options ) {
	...
	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'textures/glow.png' );
...
THREE.GPUParticleContainer = function( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function( options ) {
		...
		color.r = THREE.Math.clamp( color.r, 0, 1 );
		color.g = THREE.Math.clamp( color.g, 0, 1 );
		color.b = THREE.Math.clamp( color.b, 0, 1 );
		...
		startTimeAttribute.array[ i ] = this.time + -0.4 * 2e-2;
